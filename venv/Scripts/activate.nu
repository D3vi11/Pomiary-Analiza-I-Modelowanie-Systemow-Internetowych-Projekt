...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\kryst\Desktop\infa 1 semestr\[P]Pomiary, analiza i modelowanie systemów internetowych\Projekt\Repo\Pomiary-Analiza-I-Modelowanie-Systemow-Internetowych-Projekt\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\kryst\Desktop\infa 1 semestr\[P]Pomiary, analiza i modelowanie systemów internetowych\Projekt\Repo\Pomiary-Analiza-I-Modelowanie-Systemow-Internetowych-Projekt\venv\Scripts\deactivate.nu'
